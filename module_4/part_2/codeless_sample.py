...
class TestCodelesssamplepy():
    ...
    def test_codelesssamplepy(self):
        ...
        self.driver.set_window_size(1050, 964)
        self.driver.find_element(By.ID, "login_link").click()
        self.driver.find_element(By.ID, "id_registration-email").click()
        self.driver.find_element(By.ID, "id_registration-email").send_keys("t47669210@gmail.com")
        self.driver.find_element(By.ID, "id_registration-password1").click()
        self.driver.find_element(By.ID, "id_registration-password1").send_keys("qwertyuiop1234567890")
        self.driver.find_element(By.ID, "id_registration-password2").click()
        self.driver.find_element(By.ID, "id_registration-password2").send_keys("qwertyuiop1234567890")
        self.driver.find_element(By.NAME, "registration_submit").click()
        self.driver.find_element(By.CSS_SELECTOR, ".alertinner").click()
        self.driver.find_element(By.LINK_TEXT, "Moje konto").click()
        self.driver.find_element(By.ID, "delete_profile").click()
        self.driver.find_element(By.ID, "id_password").click()
        self.driver.find_element(By.ID, "id_password").send_keys("qwertyuiop1234567890")
